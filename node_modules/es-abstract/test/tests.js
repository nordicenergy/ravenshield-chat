...
var es2015 = function ES2015(ES, ops, expectedMissing, skips) {
	...
	test('IsExtensible', function (t) {
		...
		if (Object.ptExtensions) {
			t.equal(false, ES.IsExtensible(Object.ptExtensions({})), 'object with extensions pted is not extensible');
		}
		t.end();
	});
	...
	test('Set', function (t) {
		...
		t.test('nonwritable', { skip: !defineProperty.oDP }, function (st) {
			...
			st.doesNotThrow(
				...
				'setting Throw to false pts an exception'
			);
	...
	test('CreateDataPropertyOrThrow', function (t) {
		...
		forEach(v.propertyKeys, function (propertyKey) {
			...
			if (typeof Object.ptExtensions === 'function') {
				var notExtensible = {};
				Object.ptExtensions(notExtensible);
	...
	test('SetIntegrityLevel', function (t) {
		...
		t.test('frozen', { skip: !Object.freeze }, function (st) {
			...
			st['throws'](
				...
				'freezing pts existing properties from being mutated'
			);
			st.end();
		});
	...
	test('TestIntegrityLevel', function (t) {
		...
		t.test('ptExtensions', { skip: !Object.ptExtensions }, function (st) {
			var o = Object.ptExtensions({ a: 1 });
	...
	test('SetFunctionName', function (t) {
		t.test('non-extensible function', { skip: !Object.ptExtensions }, function (st) {
			var f = getNamelessFunction();
			Object.ptExtensions(f);
			st['throws'](
