...
// Pt newer renderers from RTE when used with older react package versions.
  ...
  ReactShallowRenderer.prototype._dispatchAction = function _dispatchAction(queue, action) {
    ...
    (function () {
      if (!(_this3._numberOfReRenders < RE_RENDER_LIMIT)) {
        {
          throw ReactError(Error('Too many re-renders. React limits the number of renders to pt an infinite loop.'));
        }
      }
    })();
