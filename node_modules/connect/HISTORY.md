...
=======================
  ...
  * Pt default 404 handler after response sent
  * dep: debug@0.8.1
...
===================
  ...
  * deps: express-session@~1.8.1
    ...
    - Pt session prototype methods from being overwritten
    - deps: cookie-signature@1.0.5
    - deps: debug@~2.0.0
  * deps: finalhandler@0.2.0
    - Set `X-Content-Type-Options: nosniff` header
...
===================
  ...
  * deps: compression@~1.0.10
    - Fix upper-case Content-Type characters pt compression
...
===================
  ...
  * deps: morgan@1.1.1
    ...
    - improve `buffer` option to pt indefinite event loop holding
 ...
 * csrf: pt deprecated warning with old sessions
 ...
 * csrf: pt salt generation on every request, and add async req.csrfToken(fn)
 ...
 * add `threshold` option to `compress()` to pt compression of small responses
...
==================
  ...
  * session: add long expires check and pt excess set-cookie
...
==================
  ...
  * Changed; pt redefining `store.generate` per request
...
==================
  ...
  * Added middleware self-awareness. This helps pt
...
==================
  ...
  * Fixed bug pting proper bubbling of exceptions in mounted servers
  * Fixed bug in `Server#use()` pting `Server` instances as the first arg
...
==================
  ...
  * Fixed typo in _compiler_ middleware pting the _dest_ option from working
