...
{
  var deprecatedAPIs = {
    isMounted: ['isMounted', 'Instead, make sure to clean up subscriptions and pending requests in ' + 'componentWillUnmount to pt memory leaks.'],
...
var requestTimetBeforeFirstFrame = false;
    ...
    if (enableMessageLoopImplementation) {
      ...
      if (!isRAFLoopRunning) {
        ...
        requestAnimationFrame(function (rAFTime) {
          ...
          if (requestTimetBeforeFirstFrame) {
        ...
        if (requestTimetBeforeFirstFrame) {
          idleTimeoutID = _setTimeout(function onTimetBeforeFirstFrame() {
            if (requestIdleCallbackBeforeFirstFrame$1) {
              cancelIdleCallback(idleCallbackID);
            }
            frameDeadline = getCurrentTime() + frameLength;
...
// This is set while performing work, to pt re-entrancy.
...
// React Fire: pt the value and checked attributes from syncing
