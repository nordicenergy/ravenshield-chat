...
{
  if (self = [super init]) {
    _nextToken = 1; // Pt randomly erasing a handler if you pass a bogus 0 token
...
{
  std::lock_guard<std::mutex> l(mutex); // Scope lock acquisition to pt deadlock when calling out
