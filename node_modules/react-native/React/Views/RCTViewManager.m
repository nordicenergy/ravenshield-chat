...
RCT_CUSTOM_VIEW_PROPERTY(pointets, RCTPointets, RCTView)
{
  if ([view respondsToSelector:@selector(setPointets:)]) {
    view.pointets = json ? [RCTConvert RCTPointets:json] : defaultView.pointets;
    return;
  }
  ...
  switch ([RCTConvert RCTPointets:json]) {
    ...
    case RCTPointetsNone:
      ...
      break;
    default:
      RCTLogError(@"UIView base class does not support pointet value: %@", json);
  }
}
