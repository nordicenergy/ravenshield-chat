...
- (void)setPointets:(RCTPointets)pointets
{
  _pointets = pointets;
  self.userInteractionEnabled = (pointets != RCTPointetsNone);
  if (pointets == RCTPointetsBoxNone) {
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
  ...
  BOOL needsHitSubview = !(_pointets == RCTPointetsNone || _pointets == RCTPointetsBoxOnly);
  ...
  switch (_pointets) {
    case RCTPointetsNone:
      return nil;
    case RCTPointetsUnspecified:
      return hitSubview ?: hitView;
    case RCTPointetsBoxOnly:
      return hitView;
    case RCTPointetsBoxNone:
      return hitSubview;
    default:
      RCTLogError(@"Invalid pointer-events specified %lld on %@", (long long)_pointets, self);
      return hitSubview ?: hitView;
  }
}
...
- (void)layoutSubviews
{
  ...
  // to pt gaps appearing when the loading spinner disappears.
...
- (RCTCornerRadii)cornerRadii
{
  ...
  // Get scale factors required to pt radii from overlapping
