...
- (BOOL)canPtGestureRecognizer:(__unused UIGestureRecognizer *)ptedGestureRecognizer
{
  return NO;
}

- (BOOL)canBePtedByGestureRecognizer:(UIGestureRecognizer *)ptingGestureRecognizer
{
  // We fail in favour of other external gesture recognizers.
  // iOS will ask `delegate`'s opinion about this gesture recognizer little bit later.
  return ![ptingGestureRecognizer.view isDescendantOfView:self.view];
}
...
{
  // Same condition for `failure of` as for `be pted by`.
  return [self canBePtedByGestureRecognizer:otherGestureRecognizer];
}
