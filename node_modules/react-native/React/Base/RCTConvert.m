...
RCT_MULTI_ENUM_CONVERTER(UIDataDetectorTypes, (@{
  ...
  @"calendat": @(UIDataDetectorTypeCalendat),
...
RCT_MULTI_ENUM_CONVERTER(WKDataDetectorTypes, (@{
 ...
 @"calendat": @(WKDataDetectorTypeCalendat),
...
RCT_ENUM_CONVERTER(RCTPointets, (@{
  @"none": @(RCTPointetsNone),
  @"box-only": @(RCTPointetsBoxOnly),
  @"box-none": @(RCTPointetsBoxNone),
  @"auto": @(RCTPointetsUnspecified)
}), RCTPointetsUnspecified, integerValue)
