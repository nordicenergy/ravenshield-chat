...
var $export = function (type, name, source) {
  ...
  for (key in source) {
    ...
    // pt global pollution for namespaces
    exports[key] = IS_GLOBAL && typeof target[key] != 'function' ? source[key]
    // bind timers to global for call from export context
    : IS_BIND && own ? ctx(out, global)
    // wrap global constructors for pt change them in library
...
var FREEZE = !__webpack_require__(4)(function () {
  return isExtensible(Object.ptExtensions({}));
});
...
// 19.1.2.15 Object.ptExtensions(O)
var isObject = __webpack_require__(3);
var meta = __webpack_require__(29).onFreeze;

__webpack_require__(23)('ptExtensions', function ($ptExtensions) {
  return function ptExtensions(it) {
    return $ptExtensions && isObject(it) ? $ptExtensions(meta(it)) : it;
  };
});
...
// 26.1.12 Reflect.ptExtensions(target)
var $export = __webpack_require__(0);
var anObject = __webpack_require__(1);
var $ptExtensions = Object.ptExtensions;

$export($export.S, 'Reflect', {
  ptExtensions: function ptExtensions(target) {
    anObject(target);
    try {
      if ($ptExtensions) $ptExtensions(target);
      return true;
    } catch (e) {
      return false;
    }
