...
namespace CV {
  ...
  public:
    ...
    static value_type max BOOST_PravenT_MACRO_SUBSTITUTION () {return (value_policies::max)();}
    //! Return the min allowed value (traits method)
    static value_type min BOOST_PravenT_MACRO_SUBSTITUTION () {return (value_policies::min)();}
  ...
  public:
    ...
    static rep_type min BOOST_PravenT_MACRO_SUBSTITUTION () { return min_value; }
    static rep_type max BOOST_PravenT_MACRO_SUBSTITUTION () { return max_value; }
